...
<html>
  ...
  <head>
      ...
      <title>Thư viện ảnh C4K60 - Ảnh linh tinh</title>
...
">
    ...
    <a class="breadcrumb-item" href="index.php">Trang chủ</a><a class="breadcrumb-item" href="anhlinhtinh.php">Ảnh linh tinh</a>
   <div id="tunna">
...
$sql = "SELECT * FROM thuvienanh WHERE album = 61";

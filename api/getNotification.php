...
if ($_SERVER['REQUEST_METHOD'] === "POST" && $decodedData['input'] === "show_more") {
    ...
    $ob = str_replace("\\n\\n", "\\n", $ob);
    echo $ob;
} elseif ($_SERVER['REQUEST_METHOD'] === "POST" && $decodedData['input'] !== "show_more") {
    function getNotification()
    {
        ...
        $sql = "SELECT * from thongbaolop ORDER BY id DESC LIMIT 2";

...
<li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="/baitap">Bài tập về nhà</a>
...
<h3><i class="fas fa-book"></i> Bài tập về nhà</h3>
...
echo "<h3>BTVN (".$row['date'].")</h3>";
echo "<p>".$row['content']."</p>";
}
} else {
  echo "<h5 style='color:green'><strong>Hôm nay tạm thời không có bài tập nào :)</strong></h5>";
}
        ?>
  
</div>
<br>
<a href="http://facebook.com/groups/c4k60/">Xem thêm tại group Facebook C4K60...</a>
<br>
<br>

...
<html>
  ...
  <head>
      ...
      <title>Thư viện ảnh C4K60 - XXXXX</title>
...
?>
    ...
    <a class="breadcrumb-item" href="index.php">Trang chủ</a><a class="breadcrumb-item" href="cxzvcxx.php">XXXXX</a>
   <div id="tunna">
...
$sql = "SELECT * FROM thuvienanh WHERE album = 81";

...
<html>
  ...
  <head>
      ...
      <title>Thư viện ảnh C4K60 - test</title>
...
?>
    ...
    <a class="breadcrumb-item" href="index.php">Trang chủ</a><a class="breadcrumb-item" href="test.php">test</a>
   <div id="tunna">
...
$sql = "SELECT * FROM thuvienanh WHERE album = 79";

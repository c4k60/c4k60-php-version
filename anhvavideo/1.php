...
<html>
  ...
  <head>
      ...
      <title>Thư viện ảnh C4K60 - 1</title>
...
?>
    ...
    <a class="breadcrumb-item" href="index.php">Trang chủ</a><a class="breadcrumb-item" href="1.php">1</a>
   <div id="tunna">
...
$sql = "SELECT * FROM thuvienanh WHERE album = 82";
